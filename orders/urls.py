...
urlpatterns = [
    ...
    path('delete/menu/(?P<confirmar_id>.*)/', views.borrar_menu, name="borrar_menu"),
    path('delete/toppings/(?P<confirmar_id>.*)/', views.borrar_Topping, name="borrar_Topping"),
    path('delete/extra/(?P<confirmar_id>.*)/', views.borrar_extra, name="borrar_extra")
